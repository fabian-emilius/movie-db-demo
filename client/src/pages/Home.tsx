  ...
  return (
    <div className='flow container'>
      ...
      <div className='flow'>
        ...
        <p>
          We are passionate about movies and created this platform to help movie lovers discover new films and manage
          their movie collections. Our mission is to provide the best movie-related experience to our users.
        </p>
      </div>
      ...
      <div className='flow grid grid-items-center'>
        <h3>Follow Us</h3>
        <div className='flex'>
          <a className='flex text-blue' href='https://www.facebook.com/' target='_blank' rel='noopener noreferrer'>
            <i className='fa fa-facebook'></i>
          </a>
          <a className='flex text-blue' href='https://www.twitter.com/' target='_blank' rel='noopener noreferrer'>
            <i className='fa fa-twitter'></i>
          </a>
          <a className='flex text-blue' href='https://www.instagram.com/' target='_blank' rel='noopener noreferrer'>
